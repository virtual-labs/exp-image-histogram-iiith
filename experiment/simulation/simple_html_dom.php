...
//        $pattern = "/([\w-:\*]*)(?:\#([\w-]+)|\.([\w-]+))?(?:\[@?(!?[\w-]+)(?:([!*^$]?=)[\"']?(.*?)[\"']?)?\])?([\/, ]+)/is";
    ...
    function setAttribute($name, $value): void {$this->__set($name, $value);}
    function hasAttribute($name) {return $this->__isset($name);}
    function removeAttribute($name): void {$this->__set($name, null);}
...
class simple_html_dom implements \Stringable {
    ...
    function load($str, $lowercase=true, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT): void {
        global $debugObject;
    ...
    function set_callback($function_name): void {
    ...
    function loadFile(): void {$args = func_get_args();$this->load_file($args);}
}
